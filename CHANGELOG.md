...
- **Anti-pattern CI check.** New `antipatterns` CI job catches: bare `|| "#"` without `|| data.url` fallback in JS assets; `IndexBuildOrchestrator` construction without logger/progress arguments.
